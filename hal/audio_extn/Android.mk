...
ifneq ($(filter sdm845 sdm710 qcs605 sdmshrike msmnile sm8150 kona lito atoll sdm660 msm8937 msm8998 $(MSMSTEPPE) $(TRINKET),$(TARGET_BOARD_PLATFORM)),)
...
ifneq ($(filter sdm845 sdm710 qcs605 sdmshrike msmnile sm8150 kona sdm660 msm8937 $(MSMSTEPPE) $(TRINKET),$(TARGET_BOARD_PLATFORM)),)
  # B-family platform uses msm8974 code base
  AUDIO_PLATFORM = msm8974
  MULTIPLE_HW_VARIANTS_ENABLED := true
endif
